...
# Use relative paths for background and CSV
current_dir = os.path.dirname(__file__)
image_path = os.path.join(current_dir, "back.jfif")
set_bg(image_path)

# -----------------------------
# Load trained model and scaler
# -----------------------------
with open(os.path.join(current_dir, 'finalized_model.sav'), 'rb') as f:
    loaded_model = pickle.load(f)

with open(os.path.join(current_dir, 'scaler.sav'), 'rb') as f:
    sc = pickle.load(f)

with open(os.path.join(current_dir, 'model_columns.pkl'), 'rb') as f:
    X_columns = pickle.load(f)

# Load dataset
food_csv_path = os.path.join(current_dir, "Export.csv")
food = pd.read_csv(food_csv_path, on_bad_lines="skip")
